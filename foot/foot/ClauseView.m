...
-(void)setLayout{
    ...
    label.text = @"                         使用条款与隐私政策\n <1>    版权声明\n本app所有内容,包括⽂文字、图⽚片、⾳音频、视频、软件、程序、以及版式设计等均在⽹网上搜集。访问者可将本app提供的内容或服务⽤用于个⼈人学习、研究或欣赏,以及其他非商业性或 非盈利性⽤用途,但同时应遵守著作权法及其他相关法律的规定,不得侵犯本app及相关权利⼈人的合法权利。除此以外,将本app任何内容或服务⽤用于其他⽤用途时,须征得本app及相关权利人的书面许可,并支付报酬。\n 本app内容原作者如不愿意在本app刊登内容,请及时通知本app,予以删除。 \n  电话:18300070795\n  电⼦子邮箱:1272871380@qq.com\n <2>在此声明该APP不涉及任何钱财交易,如有钱财交易,请及时报警!\n <3>给app不会收录用户任何隐私信息，请放心使用";
    label.font = [UIFont systemFontOfSize:15*KScreenWidth/375];
    Tool *tool = [[Tool alloc]init];
    CGFloat height = [tool getLabelHeight:label.text font:[UIFont systemFontOfSize:15]];
      label.frame = CGRectMake(20, 60,KScreenWidth-40,height+80*KScreenWidth/375);
